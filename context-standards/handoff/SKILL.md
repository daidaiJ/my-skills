...
> 💡 进度格式可选（Todo 列表 / 检查清单 / 量化描述）→ [references/progress-formats.md](references/progress-formats.md)
...
> ⚠️ 验证事项的填写规则 → [references/verification.md](references/verification.md)
...
### 已完成且已验证
- [x] <已验证项 1> — <一句话确认，如"PASS（3/3），CI #123">
- [x] <已验证项 2>
```
...
3. **写入完整 handoff 文档**：按上方模板填充，覆盖旧文件，内容必须是当前最新状态。
