...
metadata:
  short-description: "CLI design rules for coding agents"
provenance:
  origin: cursor-plugins (cli-for-agent: cli-for-agents)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/cli-for-agent/skills/cli-for-agents
