...
description: >
  Apply before writing logic: choosing core types and data structures,
  sequencing scaffold-vs-feature work, asking what concurrent actors share.
  Get the data structures right so downstream code becomes obvious.
metadata:
  short-description: "Data structures first, scaffold before features"
provenance:
  origin: cursor-plugins (pstack: principle-foundational-thinking)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/pstack/skills/principle-foundational-thinking
