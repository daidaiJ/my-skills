...
description: >
  Apply when designing types, reviewing a function signature, or writing code
  in any statically-typed language. Make illegal states unrepresentable, brand
...
metadata:
  short-description: "Type checker as proof assistant"
provenance:
  origin: cursor-plugins (pstack: principle-type-system-discipline)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/pstack/skills/principle-type-system-discipline
