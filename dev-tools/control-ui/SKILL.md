...
metadata:
  short-description: "Local Playwright/CDP harness to drive & inspect UIs"
provenance:
  origin: cursor-plugins (cursor-team-kit: control-ui)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/cursor-team-kit/skills/control-ui
