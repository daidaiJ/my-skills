...
description: >
  ...
  Concentrate guards at system boundaries (CLI, config, network, external
  APIs); trust internal types and keep business logic in pure functions.
metadata:
  short-description: "Guards at boundaries, pure logic inside"
provenance:
  origin: cursor-plugins (pstack: principle-boundary-discipline)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/pstack/skills/principle-boundary-discipline
