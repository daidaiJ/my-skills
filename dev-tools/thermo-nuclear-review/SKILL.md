...
description: >
  Comprehensive security and correctness audit of a branch's changes against
  its merge base: bugs, breaking changes, security issues, devex regressions,
  and feature-gate leaks. Use for "thermo nuclear review", pre-merge branch/PR
  diff audits, or security review of a diff. For whole-repo defect hunting
  across design/impl/engineering axes use defect-detective instead.
metadata:
  short-description: "Pre-merge security & correctness branch audit"
provenance:
  origin: cursor-plugins (thermos: thermo-nuclear-review)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/thermos/skills/thermo-nuclear-review
...
# Final Response
IF you have medium-to-high priority / risk findings, and there is a PR for this branch, then check the PR/MR discussion using the gh CLI to see if there are review comments from bots (e.g. BugBot/CodeRabbit and similar) or humans present.
...
Flag issues found by bots or others in the PR/MR discussion that you include in your report.
