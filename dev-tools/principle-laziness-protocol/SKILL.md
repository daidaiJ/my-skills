...
description: >
  Apply when refactoring, evaluating diff size, or tempted to add abstractions,
  layers, or signal threading. Bias toward deletion and the smallest change
  that solves the problem.
metadata:
  short-description: "Bias toward deletion, smallest change"
provenance:
  origin: cursor-plugins (pstack: principle-laziness-protocol)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/pstack/skills/principle-laziness-protocol
