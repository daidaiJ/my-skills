...
description: >
  ...
  messages.
metadata:
  short-description: "Four-layer docs standard: Diátaxis/Google/STE/Global English"
provenance:
  origin: cursor-plugins (pstack: technical-writing)
  license: MIT
  upstream_url: https://github.com/cursor/plugins/tree/main/pstack/skills/technical-writing
...
- Apply the **stop-slop** skill to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells (extended catalog in its `references/unslop-rules.md`).
